...
set "zipFile=Read Mode.zip"
set "extractPath=Read Mode"
...
start "" "%cd%\Read Mode\instructions.html"

REM Notify the user
echo The ZIP file has been extracted. Please follow the instructions in the opened HTML file to install the Read Mode.
